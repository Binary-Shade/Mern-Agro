...
const TourCard = ({tour}) => {
  return (
    ...
    //   </div>
    // </Link>
    <Link to={`/details/${tour.id}`} className="relative hover:-translate-y-2 cursor-pointer bg-white  transition-all duration-300 flex w-full max-w-sm sm:max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 hover:shadow-2xl shadow-md">
      <a
